...
def main():
    ...
    with sync_playwright() as p:
        ...
        pg.wait_for_timeout(300)
        r["match_drawer_opens"] = pg.eval_on_selector(
            "#skl-match-q", "el => !!el && el.offsetParent !== null"
        )
        ...
        name = pg.eval_on_selector(
            "#skl-match-results .skl-match-name", "el => el.textContent.toLowerCase()"
        )
        if "summ" not in name:
        ...
        pg.wait_for_timeout(300)
        r["esc_closes"] = pg.eval_on_selector(
