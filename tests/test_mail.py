...
class BuildMessageTests(unittest.TestCase):
    def test_reply_headers(self):
        m = mail._build_message({"email": "me@x.com"}, "you@y.com", "Re: hi", "body",
                                in_reply_to="<abc@y.com>", references="<root@y.com>")
    ...
    def test_reply_without_prior_references(self):
        m = mail._build_message({"email": "me@x.com"}, "you@y.com", "Re: hi", "b",
...
class ThreadKeyTests(unittest.TestCase):
    ...
    def test_group_threads_collapses(self):
        msgs = [
            ...
            {"uid": "2", "subject": "Re: Project plan", "date_ts": 200, "seen": False, "from": "b@x"},
