...
class EditSaveTests(unittest.TestCase):
    _FAKE = {"filename": "x.png", "thumb": "x.jpg", "original_name": "edited.png",
             "width": 2, "height": 2, "taken_at": datetime(2026, 6, 14), "exif": "{}"}
    ...
    def test_decodes_dataurl_and_saves(self):
        ...
        with mock.patch.object(P.ps, "import_image", lambda raw, name: self._FAKE):
            res = P.edit_save(P.EditSaveBody(data_url="data:image/png;base64," + png, name="edited.png"), db)
