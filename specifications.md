...
- **durable Jarvis foundation:** `/api/jarvis/workflows`, workflow triggers/runs,
  `/api/jarvis/runs`, prompt answers, and encrypted connector records
